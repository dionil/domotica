...
var hqWidgets = {
    ...
    Translate: function (text) {
            if (!this.words) {
            this.words = {
                "IP Camera"                 : {"en": "IP Camera",       "de": "IP Kamera",              "es" : "Camara IP"},
                "Description:"              : {"en": "Description:",    "de": "Beschreibung:",          "es" : "Descripcion"},
                "Close"                     : {"en": "Hide",            "de": "Ignore",                 "es" : "Cerrar"},
                "Advanced..."               : {"en": "Advanced...",     "de": "Erweitert...",           "es" : "Avanzar.."},
                "Pop up delay (ms):"        : {"en": "Pop up delay (ms):", "de": "Verzogerung (ms)",    "es" : "Pop up delay (ms):"},
                "Open door button:"         : {"en": "Open door button:",  "de": "'Tur aufmachen' Knopf:","es" : "Abrir Puerta:"},
                "Small image update(sec):"  : {"en": "Small image update(sec):",    "de": "Kleines Bild erneuern(Sek):",    "es" : "Actualizaciones de Iconos"},
                "Open door text:"           : {"en": "Open door text:", "de": "Knopfbeschrieftung:",    "es" : "Abrir Puerta Texto: "},
                "Open&nbsp;lock"            : {"en": "Open&nbsp;lock",  "de": "Aufmachen",              "es" : "Cerrar Puerta"},
                "Open the door?"            : {"en": "Open the door?",  "de": "Camara ip",         "es" : "Abrir Puerta?"},
                "Simulate click"            : {"en": "Simulate click",  "de": "Simuliere Click",        "es" : "Simular Click"},
                "Test state"                : {"en": "Test state",      "de": "Zustand testen",         "es" : ":Estado de Prueba"},
           };
        }
        if (this.words[text]) {
            ...
            if (this.words[text]["es"])
                return this.words[text]["es"];
        }
    ...
    hqButton: function (options, advOptions) {	
        ...
        var settings = {       
            ...
            gongBtnText:      "Volumen",// Text for button play gong
        ...
        var dynStates = {
            ...
            state:         hqWidgets.gState.gStateOff, // Unknown, active, inactive
            handleState:   hqWidgets.gHandlePos.gPosClosed, // Set default position to closed
            lowBattery:    null,         // If show low battery icon or not
